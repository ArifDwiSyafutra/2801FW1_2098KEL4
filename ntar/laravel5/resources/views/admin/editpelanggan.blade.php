...
@section('title')Edit Pelanggan @stop
...
<div class="widget">
					<div class="widget-header transparent">
						<h2><strong>Edit</strong> Pelanggan</h2>
					...
					<div class="widget-content padding">
						<form class="form-horizontal" role="form" method="POST" action="{{ $url }}">
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$customer->nama}}" type="text" class="form-control" id="nama" name="nama" placeholder="Nama">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$customer->telepon}}" type="text" class="form-control" id="telepon" name="telepon" placeholder="Telepon">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$customer->tempat_lahir}}" type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Tempat Lahir">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-3">
							  <input value="{{$customer->tanggal_lahir}}" type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" data-mask="9999-99-99" placeholder="yyyy-mm-dd">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							<textarea class="summernote" name="alamat" id="alamat">{{$customer->alamat}}</textarea>
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$customer->no_ktp}}" type="text" class="form-control" id="no_ktp" name="no_ktp" placeholder="No KTP">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$customer->photo_identitas}}" type="file" class="btn btn-default" id="photo_identitas" name="photo_identitas" title="Select Photo">
							</div>
						  </div>
