...
@section('title')Edit Customer Service @stop
...
<div class="widget">
					<div class="widget-header transparent">
						<h2><strong>Edit</strong> Customer Service</h2>
					...
					<div class="widget-content padding">
						<form class="form-horizontal" role="form" method="POST" action="{{ $url }}">
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$service->nama}}" type="text" class="form-control" id="nama" name="nama" placeholder="Nama">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$service->telepon}}" type="text" class="form-control" id="telepon" name="telepon" placeholder="Telepon">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$service->tempat_lahir}}" type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Tempat Lahir">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-3">
							  <input value="{{$service->tanggal_lahir}}" type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" data-mask="9999-99-99" placeholder="yyyy-mm-dd">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							<textarea class="summernote" name="alamat" id="alamat">{{$service->alamat}}</textarea>
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$service->no_ktp}}" type="text" class="form-control" id="no_ktp" name="no_ktp" placeholder="No KTP">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input value="{{$service->photo_identitas}}" type="file" class="btn btn-default" id="photo_identitas" name="photo_identitas" title="Select Photo">
							</div>
						  </div>
						  ...
						  <a href="/admin/tabelpelanggan" style="float:right;margin-right:20px;" class="btn btn-danger">I Changed My Mind !</a>
